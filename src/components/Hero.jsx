...
const Hero = () => {
  ...
  return (
    <>
      <div className="relative border-4  border-slate-900 min-h-screen">
        <img
          src="/heroBanner.png"
          alt=""
          className="w-full h-full relative object-cover min-h-screen"
        />
        ...
        <div className="absolute inset-0  flex flex-col justify-center gap-4 items-center ">
          <h1 className="text-6xl font-extrabold text-center text-slate-100">
            DISCOVER MOVIES
          </h1>
